      ...
      <div class="container md:container md:mx-auto flex flex-col gap-2 mx-auto">
         <div class="flex items-center justify-between mt-4">
            <div class="flex items-center">
               <a @click="()=> router.push('/home')"> <img src="../../../resources/logo-icon.svg" alt="" width="78" height="48" class="cursor-pointer"/> </a> 
               <div class="flex items-center ml-10 gap-9 hidden md:flex">
                  <h5 class=" text-lg font-semibold font-aileron text-black cursor-pointer " > Collections </h5>
                  <h5 class=" text-lg font-semibold font-aileron text-black cursor-pointer " > Projects </h5>
               </div>
            </div>
            ...
            <div class="flex items-center gap-7 hidden md:flex">
               <div class=" relative flex items-center justify-center bg-[#E1E1E1] hover:bg-[#6317A7] cursor-pointer w-10 h-10 rounded-full group transition ease-out duration-200 " >
                  <img src="../../../resources/brush-icon.svg" alt="" class="w-[40%] group-hover:brightness-0 group-hover:invert"/> 
                  <div class=" absolute font-aileron w-4 h-4 text-center text-white bg-gray-700 bg-opacity-75 rounded-full -right-3 -top-0 ring-white ring-1 text-xs " > T </div>
               </div>
               <div class=" relative font-aileron flex items-center justify-center rounded-full bg-[#E1E1E1] hover:bg-[#6317A7] cursor-pointer fill-white w-10 h-10 group transition ease-out duration-200 " >
                  <img src="../../../resources/string-icon.svg" alt="" class="w-[40%] group-hover:brightness-0 group-hover:invert"/> 
                  <div class=" absolute font-aileron w-4 h-4 text-center text-white bg-gray-700 bg-opacity-75 rounded-full -right-3 -top-0 ring-white ring-1 text-xs " > S </div>
               </div>
               <Popover class="relative" v-slot="{open}">
                  <PopoverButton :class="[ open ? 'text-gray-900' : 'text-gray-500', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',]" >
                     <div class=" relative flex items-center justify-center rounded-full bg-[#E1E1E1] hover:bg-[#6317A7] cursor-pointer fill-white w-10 h-10 group transition ease-out duration-200 " >
                        <img class="w-[40%] group-hover:brightness-0 group-hover:invert" src="../../../resources/box-icon.svg" alt=""/> 
                        <div class=" absolute font-aileron w-4 h-4 text-center text-white bg-gray-700 bg-opacity-75 rounded-full -right-3 -top-0 ring-white ring-1 text-xs " > A </div>
                     </div>
                  </PopoverButton>
                  <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1" >
                     <PopoverPanel class=" absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-100 max-w-md sm:px-0 " >
                        
                        <!--====================================================================
                        PROFILE VIEW START
                        =====================================================================--> 
                        <div class=" rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden bg-white w-[200px] " >
                           <div class="flex items-center justify-between flex-wrap">
                              <div class=" flex align-center justify-center w-1/2 flex-col p-3 mb-3 text-center " >
                                 <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" style="fill: #6317a7; transform: ; msfilter: " >
                              ...
                              <div class=" flex align-center justify-center w-1/2 flex-col p-3 mb-3 text-center " >
                                 <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" style="fill: #6317a7; transform: ; msfilter: " >
               ...
               <button v-if="!isLoggedIn" @click="()=> router.push('/auth')" class=" font-aileron w-24 h-9 px-2 bg-primary uppercase text-xs text-white text-center justify-center font-bold rounded-full shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out " > Login </button> 
               <Popover v-if="isLoggedIn" class="relative" v-slot="{open}">
                  <PopoverButton :class="[ open ? 'text-gray-900' : 'text-gray-500', 'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',]" >
                     <div class="flex items-center gap-4">
                        <div class=" flex items-center justify-center rounded-full bg-[#E1E1E1] fill-white w-11 h-11 " > <img src="../../../resources/user-icon.svg" alt=""/> </div>
                        <h3 class="text-[#5E5C5C] text-sm font-semibold font-aileron"> John Doe </h3>
                     </div>
                  </PopoverButton>
                  <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1" >
                     <PopoverPanel class=" absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-100 max-w-md sm:px-0 " >
                        ...
                        =====================================================================--> 
                        <div class=" rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden " v-if="isProfileScreen==='nav'" >
                           ...
                           <div class=" relative grid gap-6 bg-white px-2 py-2 sm:gap-3 sm:p-3 " >
                              <div class="ml-4 pr-4">
                                 <p @click="toggleProfile('profileView')" class="font-aileron text-base font-medium text-gray-900" > Profile </p>
                              </div>
                           </div>
                           <div class=" relative grid gap-6 bg-white px-2 py-2 sm:gap-3 sm:p-3 " >
                              <div class="ml-4 pr-4">
                                 <p class="font-aileron text-base font-medium text-gray-900" > Subscription </p>
                              </div>
                           </div>
                           <div class=" relative grid gap-6 bg-white px-2 py-2 sm:gap-3 sm:p-3 " >
                              <div class="ml-4 pr-4">
                                 <p class="font-aileron text-base font-medium text-gray-900" > Payment </p>
                              </div>
                           </div>
                           <div class=" relative grid gap-6 bg-white px-2 py-2 sm:gap-3 sm:p-3 " >
                              <div class="ml-4 pr-4">
                                 <p class="font-aileron text-base font-medium text-gray-900" > Langugae </p>
                              </div>
                           </div>
                           <div class=" relative grid gap-6 bg-white px-2 py-2 sm:gap-3 sm:p-3 " >
                              <div class="ml-4 pr-4">
                                 <p class="font-aileron text-base font-medium text-gray-900" > Settings </p>
                              </div>
                           </div>
                        </div>
                        ...
                        =====================================================================--><!--====================================================================PROFILE VIEW START=====================================================================--> 
                        <div class=" rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden bg-white w-[250px] " v-if="isProfileScreen==='profileView'" >
                           ...
                           <div class="profile-menu-content-wrap">
                              ...
                              <div class="edit-profile-btn text-center"> <button class=" font-aileron inline-block lg:mx-0 bg-[#707070] text-white font-bold rounded-full py-3 px-4 lg:px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out text-xs " > Edit Profile </button> </div>
                              <div class="proile-details p-3">
                                 <div class="profile-details-wrap p-4 bg-[#EFEFEF] rounded-md" >
                                    <div class="profile-details-item mb-3">
                                       ...
                                       <p class="font-aileron m-0 text-xs"> johndoe0007 @gmail.com </p>
                                    </div>
                                    <div class="profile-details-item mb-3">
                                    ...
                                    <div class="profile-details-item mb-3">
                                       ...
                                       <p class="font-aileron m-0 text-xs"> Loren Ispusm dssadg adgsadgsagsg </p>
                                    </div>
                                    <div class="profile-details-item mb-3">
               ...
               <div class=" relative transform transition hover:scale-105 duration-300 ease-in-out " >
                  <button class=" font-aileron text-sm uppercase text-center w-24 h-9 font-semibold text-black rounded-3xl bg-[#FBBB0B] " > create </button> 
                  <div class=" absolute cursor-pointer w-6 h-6 text-center text-white bg-gray-700 bg-opacity-75 rounded-full -right-3 -top-0 ring-white ring-1 " > + </div>
               </div>
            </div>
         </div>
         <div class=" flex items-center justify-between w-full h-11 rounded-3xl border-[#9B9B9B] border md:flex sm:block " >
            <div class="flex items-center w-full gap-3 h-11">
               <div class="flex items-center ml-4"> <img src="../../../resources/search-icon.svg" alt="" width="20" height="20"/> </div>
               <div class="relative w-full">
                  <input id="dropdown" type="text" placeholder="Search topic" @change="query=$event.target.value" class=" w-full h-[50px] border-none outline-none bg-transparent text-[#2A2A2A] text-aileron "/> 
                  <TransitionRoot :show="isOpen" enter="transition-opacity duration-75" enter-from="opacity-0" enter-to="opacity-100" leave="transition-opacity duration-150" leave-from="opacity-100" leave-to="opacity-0" >
                     <div v-if="isOpen" class=" absolute w-full bg-white rounded z-10 px-3 shadow-md mt-2 " >
                        <p class="font-poppins text-black my-2 cursor-pointer" v-for="person in filteredPeople" :key="person.id" >{{person.name}}</p>
                     </div>
                  </TransitionRoot>
               </div>
            </div>
            <div class=" hidden md:flex items-center gap-3 h-full border-l border-[#9B9B9B] mr-3 pl-3 " >
               <div :class="checkSearchType('all')" @click="toggleSearchType('all')"> All </div>
         ...
         <div class=" flex md:hidden items-center gap-3 h-full justify-center border-[#9B9B9B] mr-3 pl-3 " >
            <div :class="checkSearchType('all')" @click="toggleSearchType('all')"> All </div>
            <div :class="checkSearchType('collections')" @click="toggleSearchType('collections')" > Collections </div>
            <div :class="checkSearchType('project')" @click="toggleSearchType('project')" > Project </div>
         </div>
         <div class="flex items-center justify-between w-full hidden md:flex">
            <div class="header-badges-wrap flex items-center gap-3">
               <span class=" font-aileron bg-[#eceff4] text-xs px-3 py-2 font-bold bg-gray-100 text-[#373636] rounded-3xl shadow-md flex cursor-pointer hover:bg-primary hover:text-[#fff] " >
                  All 
            ...
            <div class="sort-filters flex items-center gap-3">
               <ViewDropdown @onChange="changeZoom" :selected="zoom" :label="'Zoom'" :options="[{label: '100%', value: '100'},{label: '80%', value: '80'},{label: '50%', value: '50'},]"/>
               <ViewDropdown @onChange="changeSort" :selected="sort" :label="'Sort By'" :options="[{label: 'Latest', value: 'latest'},{label: 'Relevance', value: 'relevance'},{label: 'Popular', value: 'popular'},]"/>
               <ViewDropdown @onChange="changeLayout" :selected="layout" :label="'View'" :options="[{label: 'List View', value: 'list'},{label: 'Card View', value: 'card'},{label: 'Grid View', value: 'grid'},]"/>
            </div>
         </div>
      </div>
   </div>
  ...
  ==============================================================================-->
   ...
   <div v-if="isMobile()" class="border-[#DEDEDE] bg-white">
      <div class="container md:container md:mx-auto flex flex-col mx-auto">
         <div class="flex flex-wrap items-center justify-between border-gray-200 border-b-[1px]">
            ...
            ===========================================================================-->
            <div class=" flex items-center justify-between w-full h-11 rounded-3xl border-[#9B9B9B] border md:flex sm:block mb-4 overflow-hidden mt-4" >
              <div class="flex items-center w-full gap-3 h-11 bg-white">
                <div class="flex items-center ml-4"> 
                  <img class="5%" src="../../../resources/search-icon.svg" alt="" width="20" height="20"/> </div>
                  <div class="relative w-[65%]">
                    <input id="dropdown" type="text" placeholder="Search topic" @change="query=$event.target.value" class=" w-full h-[50px] border-none outline-none bg-transparent text-black placeholder-black-500 font-aileron"/> 
                    <TransitionRoot :show="isOpen" enter="transition-opacity duration-75" enter-from="opacity-0" enter-to="opacity-100" leave="transition-opacity duration-150" leave-from="opacity-100" leave-to="opacity-0" >
                        <div v-if="isOpen" class=" absolute w-full bg-white rounded z-10 px-3 shadow-md mt-2 " >
                          <p class="font-poppins text-black my-2 cursor-pointer" v-for="person in filteredPeople" :key="person.id" >{{person.name}}</p>
                        </div>
      ...
      <div class="flex items-center justify-between py-4 px-3">
         <div class="container mx-auto">
            <div class="flex items-center justify-between ">
               ...
               <div class="flex"> <a class="border border-gray-500 rounded-full py-[5px] px-6 font-aileron text-gray-700 font-bold"> Login </a> </div>
            </div>
            <div class="flex flex-wrap flex-col py-10"> <a href="" class="font-bold text-[18px] text-black font-aileron pb-3">Collections</a> <a href="" class="font-bold text-[18px] text-black font-aileron pb-3">Projects</a> <a href="" class="font-bold text-[18px] text-black font-aileron pb-3">Categories</a> <a href="" class="font-bold text-[18px] text-black font-aileron pb-3">Projects</a> </div>
            <div class="flex flex-wrap gap-3 py-6 absolute bottom-0">
               <button class="flex items-center justify-center gap-1 bg-[#6317A7] px-3 py-2 rounded-full text-white w-[200px]" >
               ...
               <button class="flex items-center justify-center gap-1 bg-[#ED4E94] px-3 py-2 rounded-full text-white w-[200px]" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1); transform: ; msfilter: " >
...
export default defineComponent({
    ...
    methods: {
        ...
        checkSearchType(type: string) {
            ...
            } else return "font-aileron text-xs h-6 w-auto px-2 pt-0.5 font-bold text text-black cursor-pointer";
        },
    ...
    computed: mapState({ isLoggedIn: (state: any) => state.user.isLoggedIn, layout: (state: any) => state.layout.layout, zoom: (state: any) => state.layout.zoom, sort: (state: any) => state.layout.sort }),
    props: { title: String },
    components: { Popover, PopoverButton, PopoverPanel, ViewDropdown, TransitionRoot, CheckIcon, SelectorIcon, IonHeader, IonToolbar, IonTitle, IonContent, IonPage, IonButtons, IonIcon },
    setup() {
    ...
    /*mounted(){
      ...
      input.addEventListener("focusin", ()=>{this.isOpen=true;}); 
      input.addEventListener("blur", ()=>{this.isOpen=false;});
    },*/,
});
</script>