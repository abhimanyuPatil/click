        ...
        >
          ...
          >
            ...
            <div class="portfolio-content py-4 px-3">
                <!-- from content -->
              <div class="portfolio-title flex items-center">
                <div class="p-[8px] md:p-[10px] rounded mr-2" :style="getColor()"></div>
                <h4
                  class="text-[12px] md:text-[14px] font-semibold font-aileron text-gray-600 m-0"
                >
                  {{ item.from }}
                </h4>
              </div>
              ...
              <!-- tags -->
              <p class="font-aileron text-[#7E7E7E] text-[10px] md:text-xs">{{ item.tags }}</p>
              ...
              >
                ...
                <div
                  class="flex items-center font-poppins text-xs text-[#5E5C5C]"
                >
                  2k
                  <svg
                    v-for="item in 5"
